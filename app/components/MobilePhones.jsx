...
export default function MobilePhones() {
  return (
    <>
      <section className=" relative mt-15 mb-95">
        <section className=" flex justify-evenly w-full bg-linear-to-t  via-50% from-[#c6ec4775] ">
          <Image src={iphone1} alt="iphone image" />
          <Image src={iphone2} alt="Iphone image" />
        </section>
        <section className=" border border-t-6 border-b-0 border-s-0 border-e-0 border-[#b0da29] rounded-tr-[28%] rounded-tl-[28%]  absolute bottom-[-300px] left-0 right-0 bg-[#141414]  ">
          <h1 className="text-[40px] text-[#fcfafa] font-semibold  text-center pt-5">
          ...
          <div className=" flex justify-center gap-3 mt-8.75">
            <div className=" bg-[#1e1f1e] pt-4 pb-4 ps-3 pe-3 w-100 h-59.75 flex justify-center text-center flex-col rounded-[20px] p-[24px] gap-[24px]">
